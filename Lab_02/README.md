...
## 📝 Overview
This folder contains the documentation, original faulty project, and extracted source code for the second experiment of EEE 102. The primary objective of this lab was to troubleshoot and debug a provided multi-module VHDL project. It focuses on structural modeling, identifying syntax and logical errors, and correctly synthesizing the final design onto the FPGA.
